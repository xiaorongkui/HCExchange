...
public class AboutUsWebAcitivity extends BaseActivity {

    private WebView webView;
    private String url;
    private String title;
    private LinearLayout webView_container;
    public String path = "androidwebdata://" + System.currentTimeMillis();
...
//                }
            ...
            public Observable getObservable(Retrofit retrofit) {
                ...
                return myAccountService.getAboutUshtml(baseMaps);
            }
        };
