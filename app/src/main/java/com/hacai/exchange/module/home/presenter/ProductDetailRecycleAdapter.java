...
public class ProductDetailRecycleAdapter<T> extends BaseRecylerAdapter {
    private Context mContext;
    private List<CommonListInfo> datas;

    public ProductDetailRecycleAdapter(Context context, List<T> datas, int layoutId) {
    ...
    public void convert(CommonRecylerViewHolder holder, int position) {
        ...
        if (position == 3) account_list_item_arrow_iv.setVisibility(View.GONE);
    }
}
