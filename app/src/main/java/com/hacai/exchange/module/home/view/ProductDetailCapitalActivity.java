...
public class ProductDetailCapitalActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        webView = (WebView) findViewById(R.id.capital_protect_wb);

    }

    @Override
    protected void initData() {
        webView.loadUrl(AppNetConfig.baseUrl + AppNetConfig.urlPath + "/agreement/pro");
    ...
    protected void initTitle() {
        title_header_tv.setText(CommonUtil.getString(R.string.program_capital_ensure));
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_product_detail_capital;
    }
    ...
    private void getHtmlData(boolean b) {
        BaseApi baseapi = new BaseApi(new HttpOnNextListener() {
            ...
            public void onError(Throwable e) {
                try {
                    toast(((HandlerException.ResponeThrowable) e).message);
                } catch (Exception e1) {
                    e1.printStackTrace();
                    toast("页面加载失败");
                }
