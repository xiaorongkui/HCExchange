...
import com.hacai.exchange.BuildConfig;
...
//    static {
//        String fileName = CommonUtil.createDir("log", "logcat" + 1 + ".txt");
//        String substring = fileName.substring(0, fileName.lastIndexOf("/"));
//        File file = new File(substring);
//        if (!file.exists()) {
//            file.mkdirs();
//        }
//        SystemTool.exec("adb shell"); //执行一次
//        SystemTool.exec("chown root:root " + substring);
//        SystemTool.exec("chmod 777 " + substring);
//    }
